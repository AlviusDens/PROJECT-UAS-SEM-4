...
<div class="container mt-5 pt-4 mb-5">
    <div class="d-flex justify-content-between align-items-center mb-4 border-bottom pb-2">
        <h3 class="fw-bold text-dark mb-0"><i class="bi bi-graph-up-arrow text-success"></i> {{ $title }}</h3>
    ...
    <div class="mb-5">
        ...
        <div class="row row-cols-2 row-cols-md-4 row-cols-lg-6 g-3">
            ...
            @empty
            <div class="col-12">
                <p class="text-muted small italic ps-2">Belum ada data koleksi buku terpopuler.</p>
            </div>
            @endforelse
        </div>
    </div>
    ...
    <div class="mb-5">
        ...
        <div class="row row-cols-2 row-cols-md-4 row-cols-lg-6 g-3">
            ...
            @empty
            <div class="col-12">
                <p class="text-muted small italic ps-2">Belum ada data koleksi artikel terpopuler.</p>
            </div>
            @endforelse
        </div>
    </div>
    ...
    <div class="mb-5">
        ...
        <div class="row row-cols-2 row-cols-md-4 row-cols-lg-6 g-3">
            ...
            @empty
            <div class="col-12">
                <p class="text-muted small italic ps-2">Belum ada data koleksi jurnal terpopuler.</p>
            </div>
            @endforelse
        </div>
    </div>
    ...
    <div class="mb-5">
        ...
        <div class="row row-cols-2 row-cols-md-4 row-cols-lg-6 g-3">
            ...
            @empty
            <div class="col-12">
                <p class="text-muted small italic ps-2">Belum ada data koleksi modul terpopuler.</p>
            </div>
            @endforelse
        </div>
    </div>
